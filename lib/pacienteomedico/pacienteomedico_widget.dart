...
import 'pacienteomedico_model.dart';
export 'pacienteomedico_model.dart';

class PacienteomedicoWidget extends StatefulWidget {
  const PacienteomedicoWidget({super.key});

  @override
  State<PacienteomedicoWidget> createState() => _PacienteomedicoWidgetState();
}

class _PacienteomedicoWidgetState extends State<PacienteomedicoWidget>
    with TickerProviderStateMixin {
  late PacienteomedicoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PacienteomedicoModel());
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Expanded( //AJUSTAR AL TAMANO DEL TELEFONO
                            child: Container(
                              height: 450.0,
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    12.0),
                                                        child: Text(
                                                          'Una vez su médico lo registre como paciente, podrá registrarse como usuario',
                                                          textAlign:
                                                              TextAlign.start,
                                                          style: FlutterFlowTheme
                                                                  .of(context)
