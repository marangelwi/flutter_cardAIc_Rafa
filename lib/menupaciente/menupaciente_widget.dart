...
class MenupacienteWidget extends StatefulWidget {
  const MenupacienteWidget({super.key});

  @override
  State<MenupacienteWidget> createState() => _MenupacienteWidgetState();
}
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                ...
                                                content: Text(
                                                    'Por favor contacta a tu médico al número 311 161 2705'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  ...
                                                  content: Text(
                                                      'Estamos registrando el evento, por favor mantente quieto, no debería de tomar mucho'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
